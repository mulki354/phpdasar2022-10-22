...
<body>
  ...
  <form action="" method="post">
    <input type="text" name="keyword" size="40" autofocus autocomplete="off" placeholder="Cari disini..." class="keyword">
    <button type="submit" name="search" class="search">Cari!</button>
  </form>
  <br>
